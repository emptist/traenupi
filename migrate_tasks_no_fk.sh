#!/bin/bash
# TraeNuPI Tasks Migration Script (Disable FK Constraints)
# Temporarily disable foreign key constraints during import
# Date: 2026-05-05

set -e

echo "=== TraeNuPI Tasks Migration (Disable FK Constraints) ==="
echo ""
...
# Import tasks to psypi with FK constraints disabled
